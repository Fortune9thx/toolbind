...
ToolBind needs no other WASI-mock patches: `seal()` uses only
gl.nondet.web.render(mode="text") (handled by gltest's stock
vm.mock_web) and gl.nondet.exec_prompt with no response_format="json"
(handled by gltest's stock vm.mock_llm) -- unlike VisionaryWebAuditor's
screenshot mode or AgentIntentSettlement's prompt_non_comparative,
neither of which this contract uses.
"""
